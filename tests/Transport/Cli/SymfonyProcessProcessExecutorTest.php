...
final class SymfonyProcessProcessExecutorTest extends TestCase
{
    public function testError() : void
    {
        ...
        $this->expectExceptionMessage(sprintf('Unexpected error: sh: 1: exec: %s: not found', $command));
    ...
    public function testTimeout() : void
    {
        ...
        $this->expectExceptionMessage(
            sprintf('Unexpected error: The process "%s" exceeded the timeout of 1 seconds', "'sleep' '5'")
        );
